...
public class BulletBehaviour : MonoBehaviour {
    ...
    Sprite bulletSprite;
    BoolVariable bvGameRunning;
    BoolVariable bvGamePaused;
    ...
    void Start()
    {
        ...
        //
        bvGamePaused = BulletFactory.bulletFactoryInstance.bvGamePaused;
        bvGameRunning = BulletFactory.bulletFactoryInstance.bvGameRunning;
    }
    ...
    public void SetBulletProperty( BulletProperty bulletProperty )
    {
    ...
    /// <returns></returns>
    public IEnumerator SetBulletPropertyDelayed(BulletProperty bulletProperty, float delay)
    {
    ...
    void FixedUpdate () {
        ...
        //
        if (!bvGameRunning.data || bvGamePaused.data)
            return;
