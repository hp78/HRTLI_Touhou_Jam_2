...
public class BulletFactory : MonoBehaviour
{
    ...
    public static BulletFactory bulletFactoryInstance;
    ...
    IEnumerator SpawnBullets(Transform pfBullet,
        Transform spawnTrans,float spawnOffset, float spawnDirection, BulletProperty property,
        float delay, int spawnCount, float addAngle, bool isPlayers)
    {
            ...
            // Instantiate an enemy bullet
        {
            ...
            bullet = (Instantiate(pfBullet, spawnTrans.position, Quaternion.identity) as Transform).gameObject;
            ...
            bulletBehaviour.SetBulletProperty(property);
    ...
    /// <param name="addAngle">Angle added for each bullet spawn in set</param>
    /// <returns></returns>
    IEnumerator SpawnBulletsAt(Transform pfBullet,
    ...
    /// <param name="addAngle">Angle added for each bullet spawn in set</param>
    /// <returns></returns>
    IEnumerator SpawnBulletsComplex(Transform pfBullet, Transform spawnTrans, 
                                    ...
                                    bool isPlayers)
    {
        ...
        for (int i = 0; i < spawnCount; ++i)
        {
            ...
            bulletBehaviour.SetBulletProperty(propertyList[0].bulletProperty);
            ...
            foreach (BulletComplexPattern.ComplexProperty pattern in propertyList)
            {
                ...
                StartCoroutine(bulletBehaviour.SetBulletPropertyDelayed(pattern.bulletProperty, propertyStart));
